...
namespace pma
{
	namespace math
	{
		...
		public:
			...
			inline Vector3D<T> MakeZZZ(void) { return Vector3D<T>(m_z, m_z, m_z); }
			...
			friend std::ostream & operator<< (std::ostream & paramOutput, const Vector3D<T> & paramVector)
			{
